...
const GetAheadSection = () => {
  return (
    <Column className="bg-white w-full py-12 md:py-16 xl:py-16 2xl:py-20 xl:min-h-72 2xl:h-75 items-center justify-center px-4 sm:px-6 md:px-12 lg:px-16 xl:px-16 2xl:px-25">
