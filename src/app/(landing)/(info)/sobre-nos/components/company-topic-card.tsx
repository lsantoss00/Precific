...
const CompanyTopicCard = ({
  ...
  <Column className="relative w-full xl:max-w-2xl items-center justify-center space-y-6 rounded-lg bg-black/40 px-4 py-6 lg:h-60 lg:flex-row lg:space-y-0 lg:px-0 lg:py-0">
