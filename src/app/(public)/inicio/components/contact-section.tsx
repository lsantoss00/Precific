...
const ContactSection = () => {
  return (
    <Flex
      id="contato"
      className="relative bg-primary w-full xl:min-h-[50rem] 2xl:h-220 flex-col lg:flex-row items-stretch justify-between bg-[url('/landing-page/hero-section-background.webp')] bg-cover bg-center bg-no-repeat overflow-hidden"
    >
