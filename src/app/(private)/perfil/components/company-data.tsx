    ...
    <Card className="w-full p-6 rounded-md flex space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Column className="space-y-2 col-span-2">
          ...
          <Input id="company_name" disabled value={company?.company_name} />
        </Column>
        <Column className="space-y-2 col-span-2">
        ...
        <Column className="space-y-2 col-span-2 md:col-span-1">
          ...
          <Input id="state" maxLength={2} disabled value={company?.state} />
        </Column>
        <Column className="space-y-2 col-span-2 md:col-span-1">
        ...
        <Column className="space-y-2 col-span-2">
          ...
          <Input id="street_address" disabled value={company?.street_address} />
        </Column>
        <Column className="space-y-2 col-span-2 md:col-span-1">
          <Label htmlFor="street_number">Número</Label>
          <Input id="street_number" disabled value={company?.street_number} />
        </Column>
        <Column className="space-y-2 col-span-2 md:col-span-1">
